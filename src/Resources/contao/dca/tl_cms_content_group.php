...
,   'list' => [
        ...
        ,   'panel_callback'        => [
                'cms_help' => ['marketing_suite.listener.data_container.content_group', 'addHelp']
            ]
    ...
    ,   'operations' => [
        ...
        ,   'toggle_always_use_this' => [
            ...
            ,   'attributes'        => 'data-action="contao--scroll-offset#store" onclick="return CMSBackend.toggleFieldReload(this,%s)"'
            ]
        ]
    ]
,   'palettes' => [
